...
<body style="background-color: rgba(0, 12, 27, 1)">
    ...
    <main class="mb-5">
                            ...
                            <form action="/penjualan/simpan" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" style="background-color: rgba(0, 46, 107, 0.60)"
                                        ...
                                        required autofocus id="PenjualanID">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="date" style="background-color: rgba(0, 46, 107, 0.60)"
                                        class="form-control" placeholder="Masukkan Tanggal Penjualan"
                                        name="TanggalPenjualan" required id="TanggalPenjualan">
                                </div>
                                <div class="mb-3">
                        ...
                        <thead>
                            <tr>
                                <th style="background-color: rgba(0, 102, 98, 0.748)"><i class="bi bi-key"
                                        style="background-color: rgba(0, 102, 98, 0.1)"></i> PenjualanID</th>
                                <th style="background-color: rgba(0, 102, 98, 0.748)"><i class="bi bi-calendar"
                                        style="background-color: rgba(0, 102, 98, 0.1)"></i> TanggalPenjualan
                                </th>
                                <th style="background-color: rgba(0, 102, 98, 0.748)"><i class="bi bi-currency-dollar"
                                        style="background-color: rgba(0, 102, 98, 0.1)"></i> TotalHarga</th>
                                <th style="background-color: rgba(0, 102, 98, 0.748)"><i class="bi bi-key"
        ...
        <div class="container pt-4">
            {{ $penjualan->appends(compact('perPage'))->links() }}
        </div>
    </main>
    ...
    <script>
        document.getElementById('pagination').onchange = function() {
            window.location = "{!! $penjualan->url(1) !!}&perPage=" + this.value;
        };
    </script>
