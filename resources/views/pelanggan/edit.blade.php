            ...
            <div class="container-fluid ps-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/pelanggan"><i class="bi bi-person-heart"></i> Pelanggan</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="container">
                <div class="container d-flex justify-content-center pt-5">
                    <div class="container border border-primary rounded-4 d-flex table-responsive" style="width: 23rem; height: 39.4rem;">
                        ...
                        <a class="btn btn-close" href="/pelanggan"></a>
                    </div>
                        <div class="container my-5" style="width: 20rem; margin-top: 3rem; padding-top: 1rem">
                            <center><h3>Edit Data Pelanggan <span><u>{{ $pelanggan->PelangganID }}</u></span></h3></center>
                            <center><h4><span><i><u>{{ $pelanggan->NamaPelanggan }}</u></span></i></h4></center>
                            <form action="/pelanggan/{{ $pelanggan->PelangganID }}" method="POST">
                                ...
                                <div class="mb-3 pt-3">
                                    ...
                                    <input type="number" style="background-color: rgba(0, 46, 107, 0.60)"
                                        class="form-control" value="{{ $pelanggan->PelangganID }}" placeholder="Masukkan ID Pelanggan" name="PelangganID" autofocus required
                                        id="PelangganID">
                                </div>
                                <div class="mb-3">
                                    <label for="NamaPelanggan" class="form-label">NamaPelanggan</label>
                                    <input type="text" style="background-color: rgba(0, 46, 107, 0.60)"
                                        class="form-control" value="{{ $pelanggan->NamaPelanggan }}" placeholder="Masukkan Nama Pelanggan" name="NamaPelanggan"
                                        required id="NamaPelanggan">
                                </div>
                                <div class="mb-3">
                                    <label for="Alamat" class="form-label">Alamat</label>
                                    <input type="text" style="background-color: rgba(0, 46, 107, 0.60)"
                                        class="form-control" value="{{ $pelanggan->Alamat }}" placeholder="Masukkan Alamat Pelanggan" name="Alamat"
                                        required id="Alamat">
                                </div>
                                <div class="mb-3">
                                    <label for="NomorTelepon" class="form-label">NomorTelepon</label>
                                    <input type="number" style="background-color: rgba(0, 46, 107, 0.60)"
                                        class="form-control" value="{{ $pelanggan->NomorTelepon }}" placeholder="Masukkan Nomor Telepon Pelanggan" name="NomorTelepon"
                                        required id="NomorTelepon">
                                </div>
